...
**Umbraco 8**  
Latest release for Umbraco 8 is [**v2.0.9**](https://github.com/skybrud/Skybrud.Umbraco.Redirects/releases/tag/v2.1.0):

```
Install-Package Skybrud.Umbraco.Redirects -Version 2.1.0
```
