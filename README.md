...
**Umbraco 8**  
Latest release for Umbraco 8 is [**v2.0.4**](https://github.com/skybrud/Skybrud.Umbraco.Redirects/releases/tag/v2.0.4):

```
Install-Package Skybrud.Umbraco.Redirects -Version 2.0.4
```
