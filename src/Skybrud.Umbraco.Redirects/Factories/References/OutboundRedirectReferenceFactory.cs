...
public class OutboundRedirectReferenceFactory : IDataValueReferenceFactory, IDataValueReference {
    ...
    public OutboundRedirectReferenceFactory(RedirectsModelFactory modelsFactory) {
    ...
    public IEnumerable<UmbracoEntityReference> GetReferences(object? value) {
        ...
        IRedirectDestination? destination = _modelsFactory.ParseOutboundRedirect(result)?.Destination;
    ...
    public bool IsForEditor(IDataEditor? dataEditor) => dataEditor is not null && dataEditor.Alias.InvariantEquals(OutboundRedirectPropertyEditor.EditorAlias);
