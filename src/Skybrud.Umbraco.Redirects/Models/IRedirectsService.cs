...
namespace Skybrud.Umbraco.Redirects.Models {
    ...
    public interface IRedirectsService {
        ...
        RedirectItem AddRedirect(int rootNodeId, string url, RedirectDestination destination);
        ...
        /// <returns>An instance of <see cref="RedirectItem"/> representing the created redirect.</returns>
        RedirectItem AddRedirect(int rootNodeId, string url, RedirectDestination destination, bool permanent, bool isRegex, bool forwardQueryString);
