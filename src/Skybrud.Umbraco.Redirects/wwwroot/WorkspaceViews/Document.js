...
export class RedirectsDocumentWorkspaceViewElement extends RedirectsElementBase {
...
customElements.define("redirects-document-workspace-view", RedirectsDocumentWorkspaceViewElement);

export default RedirectsDocumentWorkspaceViewElement;